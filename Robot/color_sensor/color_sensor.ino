...
void loop() {
  ...
  c_out5 = analogRead(Out5);
  c_out4 = analogRead(Out4);
  c_out3 = analogRead(Out3);
  c_out2 = analogRead(Out2);
  c_out1 = analogRead(Out1);
  Serial.print("Output 5 :");
  Serial.println(c_out5);
  Serial.print("Output 4 :");
  Serial.println(c_out4);
  Serial.print("Output 3 :");
  Serial.println(c_out3);
  Serial.print("Output 2 :");
  Serial.println(c_out2);
  Serial.print("Output 1 :");
  Serial.println(c_out1);
